...
export type Context<in out Route extends RouteSchema = {}, in out Singleton extends SingletonBase = {
    ...
    query: undefined extends Route['query'] ? Record<string, string> : PrettifyIfObject<Route['query']>;
    params: undefined extends Route['params'] ? undefined extends Path ? Record<string, string> : Path extends `${string}/${':' | '*'}${string}` ? ResolvePath<Path> : never : PrettifyIfObject<Route['params']>;
    headers: undefined extends Route['headers'] ? Record<string, string | undefined> : PrettifyIfObject<Route['headers']>;
    cookie: undefined extends Route['cookie'] ? Record<string, Cookie<string | undefined>> : Record<string, Cookie<string | undefined>> & {
    ...
    */
    error: {} extends Route['response'] ? typeof status : <const Code extends keyof Route['response'] | InvertedStatusMap[Extract<InvertedStatusMapKey, keyof Route['response']>], const T extends Code extends keyof Route['response'] ? Route['response'][Code] : Code extends keyof StatusMap ? Route['response'][StatusMap[Code]] : never>(code: Code, response: T) => ElysiaCustomStatusResponse<Code, T>;
} & Singleton['decorator'] & Singleton['derive'] & Singleton['resolve']>;
